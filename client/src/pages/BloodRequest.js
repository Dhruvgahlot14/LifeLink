...
export default function BloodRequest() {
  ...
  const submit = async () => {
    ...
    setLoading(true);
    try {
      await axios.post(`${process.env.REACT_APP_API_URL || "http://localhost:5000"}/api/request`, data);
      const res = await axios.post(`${process.env.REACT_APP_API_URL || "http://localhost:5000"}/api/request/find-blood`, {
